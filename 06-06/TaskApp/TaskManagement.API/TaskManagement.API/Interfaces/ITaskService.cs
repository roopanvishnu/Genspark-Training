...
public interface ITaskService
{
    ...
    Task<bool> UpdateStatusByTeamMemberAsync(Guid taskId, string teamMemberId, string status, string? comment);
    Task<bool> DeleteTaskAsync(Guid id, string deletedBy);
    Task<List<TaskDto>> GetDeletedTasksAsync();
